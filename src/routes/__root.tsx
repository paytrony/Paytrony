...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Buy an NFT tier, refer friends, and earn instant wallet credits equal to their purchase. Demo simulation." },
      ...
      { property: "og:image", content: "https://paytrony.com/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { name: "twitter:image", content: "https://paytrony.com/og-image.jpg" },
    ],
    links: [
