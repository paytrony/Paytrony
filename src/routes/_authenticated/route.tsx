          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
            ...
            <nav className="flex items-center gap-3 text-sm">
              {isAdmin && (
                <Link
                  to="/admin"
                  className={`inline-flex items-center gap-1.5 rounded-md border px-3 py-1.5 text-xs font-mono uppercase tracking-wide ${pathname.startsWith("/admin") ? "border-primary bg-primary/10 text-primary" : "border-primary/40 text-primary hover:bg-primary/10"}`}
                >
              ...
              <div className="relative" onClick={(e) => e.stopPropagation()}>
                ...
                {menuOpen && (
                  <div className="absolute right-0 z-50 mt-2 w-64 overflow-hidden rounded-md border border-border bg-background shadow-lg">
                    ...
                    {menuItem("/packages", "Buy NFT", <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4Z"/><path d="M3 6h18"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>)}
                    {menuItem("/mining", "Mining", <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M14 12l-8 8-3-3 8-8"/><path d="M14 12l3-3 5 5-3 3"/><path d="M9 7l4-4 4 4-4 4"/></svg>)}
                    ...
                    {menuItem("/wallet", "Wallet", <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 12V7H3v11a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3"/><path d="M21 7V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2"/><path d="M16 12h.01"/></svg>, { badge: <Badge n={recentEarnings} tone="primary" /> })}
